...
\begin{itemize}
  \item The GPU pipeline did not make full use of the compute available. More work could be done to implement a
    double-buffered dispatch architecture to hide overhead, and make use of a hybrid system that simultaneously multiplies
    matrices on CPU threads to maximise throughput.

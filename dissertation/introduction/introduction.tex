...
smaller window of instructions (instead of the whole program), to identify how `local' a program's ILP is~\cite{wall-ilp} \cite{future-ilp} \cite{ilp-spec95}.
...
the length of dependency paths ending at each register, eventually picking out the longest path at the end of the trace~\cite{wall-ilp}~\cite{ilp-spec95}~\cite{perpi}.

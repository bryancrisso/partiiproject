...
exploitable ILP depends on the structure of the executed program. A dynamic execution of a program will have a
...
that a single-threaded pipeline equipped with the data-driven optimisations beats the performance 
of the naive baseline in most cases. Furthermore, by distributing expression reduction and matrix multiplication workloads over 

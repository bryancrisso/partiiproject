...
(\hyperref[sec:core]{Section 2.1}) should be completed, and the CPU-based dense
matrix computation library should show a performance improvement over the naive
baseline for computing longest paths in register-only DDGs.
